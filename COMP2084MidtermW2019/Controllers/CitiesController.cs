...
namespace COMP2084MidtermW2019.Controllers
{
    public class CitiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CityId,Name,YearFounded,Population,CountryId")] City city)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CityId,Name,YearFounded,Population,CountryId")] City city)
        {
            if (ModelState.IsValid)
            {
